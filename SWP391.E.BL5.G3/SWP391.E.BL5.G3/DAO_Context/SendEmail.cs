...
namespace SWP391.E.BL5.G3.DAO_Context
{
  ...
  string phoneNumber)
        ...
        public static bool theSendEmailRegisterTravelAgent(string fromEmail, string toEmail, string subject, string body, string smtpServer, int smtpPort, string smtpUsername, string smtpPassword)
        {
            DAO dal = new DAO();
            try
            {
